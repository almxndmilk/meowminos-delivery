...
each smell, the fix I made, and the corresponding commit.

\section{Smell 1: Abbreviated Variable Name in Constructor \normalfont\small — commit \texttt{5e4f6bd}}
...
\section{Smell 4: Implicit \texttt{else} in \texttt{update()} \normalfont\small — commit \texttt{d571704}}
